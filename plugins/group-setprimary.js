...
if (!who) return conn.reply(m.chat, `ᜊ Por favor, menciona a un Socket para hacerlo Bot principal del grupo.`, m)
if (!subBots.includes(who)) return conn.reply(m.chat, `ꕥ El usuario mencionado no es un Socket de: *${botname}*.`, m)
if (chat.primaryBot === who) {
return conn.reply(m.chat, `✦ @${who.split`@`[0]} ya esta como Bot primario en este grupo.`, m, { mentions: [who] });
}
try {
chat.primaryBot = who
